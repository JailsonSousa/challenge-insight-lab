...
import { Container, Subtitle, Description, Route } from './styles';
  ...
  return (
    <Container>
      ...
      <Description>
        ...
        qualquer resultado de pesquisa ou lista de empregos, anexe .json ao URL
        que você usaria no site HTML de empregos do GitHub. Por exemplo, ao
        pesquisar empregos em Python perto de Nova York no site, sou levado a
        este url:
      </Description>
      ...
      <Description>
        A API também oferece suporte à paginação. /positions.json, por exemplo,
        irá retornar apenas 50 posições por vez. Você pode paginar os resultados
        adicionando um parâmetro de página para suas consultas. A paginação
        começa por padrão em 0.
      </Description>
